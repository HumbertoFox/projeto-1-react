...
import { SectionLogin, DivMenus, DivIconDoble, MainMenu } from "../styles/mainpagestyle";
        ...
        <MainMenu>
            ...
            <DivMenus>
                <DivIconDoble>
                    ...
                    <Link to={"/"} title="Editar Paciente">
                        <FontAwesomeIcon icon="fa-solid fa-bed" />
                    </Link>
                </DivIconDoble>
                <DivIconDoble>
                    <Link to={"/"} title="Cadastrar Doutores">
                        <FontAwesomeIcon icon="fa-solid fa-book-medical" />
                    </Link>
                    <Link to={"/"} title="Cadastrar Usuário">
                        <FontAwesomeIcon icon="fa-solid fa-book-medical" />
                    </Link>
                </DivIconDoble>
                <DivIconDoble>
