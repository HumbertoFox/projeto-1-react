...
$query_get_consult = "SELECT consultation_id, consultation.cpf, name, consultation.crm, plan, consultdatestart FROM consultation JOIN cpf on consultation.cpf = cpf.cpf JOIN crm on consultation.crm = 5000";
